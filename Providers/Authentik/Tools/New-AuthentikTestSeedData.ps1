...
$coreUsers = @(
    ...
    [ordered]@{ Username = 'hkobayashi'; Name = 'Hana Kobayashi'; Type = 'external'; IsActive = 'TRUE'; Title = 'Security Consultant'; Department = 'Contractors'; Manager = ''; Groups = 'Contractors'; LabBadgeId = 'B-2001'; LabClearanceLevel = 'Secret'; LabIsContractor = 'TRUE'; LabRiskScore = '55'; LabEntitlements = 'wiki'; Tier = 'Core'; Purpose = 'External type, contractor flag set; denied by policy' }
