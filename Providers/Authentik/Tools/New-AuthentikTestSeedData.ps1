...
$coreUsers = @(
    ...
    [ordered]@{ Username = 'jnino'; Name = $P['jnino'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Platform Engineer'; Department = 'Engineering'; Manager = 'awhitfield'; Groups = 'All-Staff;Dept-Engineering;Team-Platform'; LabBadgeId = 'B-1002'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '35'; LabEntitlements = 'vpn;wiki'; Tier = 'Core'; Purpose = 'Accented name; three-deep group membership' }
    [ordered]@{ Username = 'zmueller'; Name = $P['zmueller'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Platform Engineer'; Department = 'Engineering'; Manager = 'jnino'; Groups = 'All-Staff;Dept-Engineering;Team-Platform;Site-Zurich'; LabBadgeId = 'B-1003'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '28'; LabEntitlements = 'vpn;wiki'; Tier = 'Core'; Purpose = 'Accented name; member of the accented group' }
    [ordered]@{ Username = 'mbell'; Name = $P['mbell'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Sales Director'; Department = 'Sales'; Manager = 'awhitfield'; Groups = 'All-Staff;Dept-Sales'; LabBadgeId = 'B-1004'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '41'; LabEntitlements = 'expenses'; Tier = 'Core'; Purpose = 'A department with no children' }
    [ordered]@{ Username = 'praghunathan'; Name = $P['praghunathan'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Finance Manager'; Department = 'Finance'; Manager = 'awhitfield'; Groups = 'All-Staff;Dept-Finance'; LabBadgeId = 'B-1005'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '19'; LabEntitlements = 'expenses;payroll'; Tier = 'Core'; Purpose = 'The only user the payroll policy admits' }
    [ordered]@{ Username = 'talvarez'; Name = $P['talvarez'].DisplayName; Type = 'internal'; IsActive = 'FALSE'; Title = 'Account Executive'; Department = 'Sales'; Manager = 'mbell'; Groups = 'All-Staff;Dept-Sales'; LabBadgeId = 'B-1006'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '67'; LabEntitlements = 'expenses'; Tier = 'Core'; Purpose = 'Disabled account that still holds memberships' }
    [ordered]@{ Username = 'hkobayashi'; Name = $P['hkobayashi'].DisplayName; Type = 'external'; IsActive = 'TRUE'; Title = 'Security Consultant'; Department = 'Contractors'; Manager = ''; Groups = 'Contractors'; LabBadgeId = 'B-2001'; LabClearanceLevel = 'Secret'; LabIsContractor = 'TRUE'; LabRiskScore = '55'; LabEntitlements = 'wiki'; Tier = 'Core'; Purpose = 'External type, contractor flag set; denied by policy; kanji name, which must not be folded back to Latin' }
    [ordered]@{ Username = 'ofitzgerald'; Name = $P['ofitzgerald'].DisplayName; Type = 'external'; IsActive = 'TRUE'; Title = 'UX Contractor'; Department = 'Contractors'; Manager = ''; Groups = 'Contractors'; LabBadgeId = 'B-2002'; LabClearanceLevel = 'Unclassified'; LabIsContractor = 'TRUE'; LabRiskScore = '73'; LabEntitlements = ''; Tier = 'Core'; Purpose = 'Contractor with no entitlements at all' }
    [ordered]@{ Username = 'nsorensen'; Name = $P['nsorensen'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Intern'; Department = 'Engineering'; Manager = 'jnino'; Groups = 'All-Staff;Dept-Engineering'; LabBadgeId = ''; LabClearanceLevel = 'Unclassified'; LabIsContractor = 'FALSE'; LabRiskScore = '8'; LabEntitlements = ''; Tier = 'Core'; Purpose = 'No badge id; a report must cope with a missing attribute' }
    ...
    # other provider; only the Authentik attributes are written here. The username stays ASCII
    # because it is what the API path and the seed prefix are built from; the writing system
    # lives in the name.
    [ordered]@{ Username = 'jjiang'; Name = $P['jjiang'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Site Reliability Engineer'; Department = 'Engineering'; Manager = 'jnino'; Groups = 'All-Staff;Dept-Engineering;Team-Platform'; LabBadgeId = 'B-1021'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '22'; LabEntitlements = 'vpn;wiki'; Tier = 'Core'; Purpose = 'Han name, family name first, separated by an ideographic space rather than U+0020' }
    [ordered]@{ Username = 'tyoshida'; Name = $P['tyoshida'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Build Engineer'; Department = 'Engineering'; Manager = 'jnino'; Groups = 'All-Staff;Dept-Engineering'; LabBadgeId = 'B-1022'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '18'; LabEntitlements = 'vpn;wiki'; Tier = 'Core'; Purpose = 'A surname above the basic plane, so one character occupies two UTF-16 units' }
    [ordered]@{ Username = 'dvolkov'; Name = $P['dvolkov'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Infrastructure Engineer'; Department = 'Engineering'; Manager = 'awhitfield'; Groups = 'All-Staff;Dept-Engineering'; LabBadgeId = 'B-1023'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '31'; LabEntitlements = 'vpn'; Tier = 'Core'; Purpose = 'Cyrillic homoglyphs, which a duplicate check made by eye cannot tell from Latin' }
    [ordered]@{ Username = 'gpapadopoulos'; Name = $P['gpapadopoulos'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Financial Analyst'; Department = 'Finance'; Manager = 'awhitfield'; Groups = 'All-Staff'; LabBadgeId = 'B-1024'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '15'; LabEntitlements = 'expenses'; Tier = 'Core'; Purpose = 'In no department group, because praghunathan is meant to be the only member the payroll rule admits. Greek final sigma, so upper-casing and lower-casing the name does not return the name' }
    [ordered]@{ Username = 'malahmad'; Name = $P['malahmad'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Network Engineer'; Department = 'Engineering'; Manager = 'awhitfield'; Groups = 'All-Staff;Dept-Engineering'; LabBadgeId = 'B-1025'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '27'; LabEntitlements = 'vpn;wiki'; Tier = 'Core'; Purpose = 'Right-to-left text, stored in one order and displayed in another once Latin joins it' }
    [ordered]@{ Username = 'jmarchetti'; Name = $P['jmarchetti'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Campaign Manager'; Department = 'Marketing'; Manager = 'mbell'; Groups = 'All-Staff'; LabBadgeId = 'B-1026'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '44'; LabEntitlements = 'wiki'; Tier = 'Core'; Purpose = 'The same José as jnino to the eye, stored decomposed, so the two are different strings' }
    [ordered]@{ Username = 'iisik'; Name = $P['iisik'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'HR Advisor'; Department = 'Human Resources'; Manager = 'awhitfield'; Groups = 'All-Staff'; LabBadgeId = 'B-1027'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '11'; LabEntitlements = 'wiki'; Tier = 'Core'; Purpose = 'Turkish dotted and dotless i, which lower-case differently under a Turkish culture' }
    [ordered]@{ Username = 'jweiss'; Name = $P['jweiss'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Account Executive'; Department = 'Sales'; Manager = 'mbell'; Groups = 'All-Staff;Dept-Sales'; LabBadgeId = 'B-1028'; LabClearanceLevel = 'Confidential'; LabIsContractor = 'FALSE'; LabRiskScore = '38'; LabEntitlements = 'expenses'; Tier = 'Core'; Purpose = 'An eszett, which upper-cases into two characters and makes the name longer' }
    [ordered]@{ Username = 'schaudhary'; Name = $P['schaudhary'].DisplayName; Type = 'internal'; IsActive = 'TRUE'; Title = 'Data Engineer'; Department = 'Engineering'; Manager = 'jnino'; Groups = 'All-Staff;Dept-Engineering;Team-Platform'; LabBadgeId = 'B-1029'; LabClearanceLevel = 'Secret'; LabIsContractor = 'FALSE'; LabRiskScore = '9'; LabEntitlements = 'vpn;wiki'; Tier = 'Core'; Purpose = 'Devanagari combining vowel signs, so character count and visible marks are different numbers' }
)
