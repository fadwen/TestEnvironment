...
# report correctly.
$coreUsers = @(
    [ordered]@{ Key = 'awhitfield'; GivenName = $P['awhitfield'].GivenName; FamilyName = $P['awhitfield'].Surname; Population = 'staff'; Title = 'Chief Executive'; Department = 'Executive'; Enabled = 'TRUE'; MfaEnabled = 'TRUE'; BadgeId = 'B-1001'; Contractor = 'FALSE'; Entitlements = 'vpn;wiki;expenses'; Groups = 'all-staff;leadership'; Tier = 'Core'; Purpose = 'Top of the chain, and the only member of Leadership' }
    [ordered]@{ Key = 'jnino'; GivenName = $P['jnino'].GivenName; FamilyName = $P['jnino'].Surname; Population = 'staff'; Title = 'Principal Engineer'; Department = 'Engineering'; Enabled = 'TRUE'; MfaEnabled = 'TRUE'; BadgeId = 'B-1002'; Contractor = 'FALSE'; Entitlements = 'vpn;wiki'; Groups = 'all-staff;engineering;platform'; Tier = 'Core'; Purpose = 'Accented name with an ASCII username, and three-deep group membership' }
    [ordered]@{ Key = 'zmueller'; GivenName = $P['zmueller'].GivenName; FamilyName = $P['zmueller'].Surname; Population = 'staff'; Title = 'Staff Engineer'; Department = 'Engineering'; Enabled = 'TRUE'; MfaEnabled = 'FALSE'; BadgeId = 'B-1003'; Contractor = 'FALSE'; Entitlements = 'vpn'; Groups = 'all-staff;engineering'; Tier = 'Core'; Purpose = 'Accented name, and MFA off where most of the directory has it on' }
    [ordered]@{ Key = 'mbell'; GivenName = $P['mbell'].GivenName; FamilyName = $P['mbell'].Surname; Population = 'staff'; Title = 'Account Executive'; Department = 'Sales'; Enabled = 'FALSE'; MfaEnabled = 'TRUE'; BadgeId = 'B-1004'; Contractor = 'FALSE'; Entitlements = 'expenses'; Groups = 'all-staff;sales'; Tier = 'Core'; Purpose = 'Disabled but still in every group; the half-finished offboarding that membership reports count as active' }
    [ordered]@{ Key = 'praghunathan'; GivenName = $P['praghunathan'].GivenName; FamilyName = $P['praghunathan'].Surname; Population = 'staff'; Title = 'Financial Controller'; Department = 'Finance'; Enabled = 'TRUE'; MfaEnabled = 'TRUE'; BadgeId = 'B-1005'; Contractor = 'FALSE'; Entitlements = 'expenses;payroll'; Groups = 'all-staff;finance'; Tier = 'Core'; Purpose = 'In the only group the finance application is assigned to' }
    [ordered]@{ Key = 'talvarez'; GivenName = $P['talvarez'].GivenName; FamilyName = $P['talvarez'].Surname; Population = 'staff'; Title = 'Systems Architect'; Department = 'IT'; Enabled = 'TRUE'; MfaEnabled = 'TRUE'; BadgeId = 'B-1006'; Contractor = 'FALSE'; Entitlements = 'vpn;wiki'; Groups = 'all-staff;engineering;sales'; Tier = 'Core'; Purpose = 'In two departments at once, so any per-user department assumption is wrong about him' }
    [ordered]@{ Key = 'hkobayashi'; GivenName = $P['hkobayashi'].GivenName; FamilyName = $P['hkobayashi'].Surname; Population = 'contractors'; Title = 'Security Consultant'; Department = 'Contractors'; Enabled = 'TRUE'; MfaEnabled = 'FALSE'; BadgeId = 'C-2001'; Contractor = 'TRUE'; Entitlements = 'wiki'; Groups = 'contractors'; Tier = 'Core'; Purpose = 'Kanji name, a contractor flag that is true, and no membership of the staff chain at all' }
    [ordered]@{ Key = 'ofitzgerald'; GivenName = $P['ofitzgerald'].GivenName; FamilyName = $P['ofitzgerald'].Surname; Population = 'contractors'; Title = 'UX Contractor'; Department = 'Contractors'; Enabled = 'TRUE'; MfaEnabled = 'FALSE'; BadgeId = ''; Contractor = 'TRUE'; Entitlements = ''; Groups = 'contractors'; Tier = 'Core'; Purpose = 'No badge id and no entitlements, so a report has to cope with attributes that are simply absent' }
