...
$coreUsers = @(
    ...
    # The script cohort. Their names come from Core/Data/SeedPeople.csv, the same as in every
    # other provider; only the FreeIPA attributes are written here. The username stays a plain
    # POSIX name because FreeIPA constrains it; the writing system lives in the given name,
    # surname and gecos, which are DirectoryString here and hold it without complaint.
    [ordered]@{ Username = 'jjiang'; GivenName = $P['jjiang'].GivenName; Surname = $P['jjiang'].Surname; DisplayName = $P['jjiang'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Site Reliability Engineer'; OrgUnit = 'Engineering'; Manager = 'jnino'; Groups = 'all-staff;dept-engineering;team-platform'; EmployeeNumber = 'E1021'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'zh-CN'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'Han name, family name first, separated by an ideographic space rather than U+0020, so the gecos a client renders is not split by anything that splits on a plain space' }
    [ordered]@{ Username = 'tyoshida'; GivenName = $P['tyoshida'].GivenName; Surname = $P['tyoshida'].Surname; DisplayName = $P['tyoshida'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Build Engineer'; OrgUnit = 'Engineering'; Manager = 'jnino'; Groups = 'all-staff;dept-engineering'; EmployeeNumber = 'E1022'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'ja-JP'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'A surname above the basic plane, so one character is two UTF-16 units and Windows PowerShell measures the name one longer than a reader counts' }
    [ordered]@{ Username = 'dvolkov'; GivenName = $P['dvolkov'].GivenName; Surname = $P['dvolkov'].Surname; DisplayName = $P['dvolkov'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Infrastructure Engineer'; OrgUnit = 'Engineering'; Manager = 'awhitfield'; Groups = 'all-staff;dept-engineering'; EmployeeNumber = 'E1023'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'ru-RU'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'Cyrillic letters drawn the same as Latin ones, so two accounts can look identical in a console listing and differ in the directory' }
    [ordered]@{ Username = 'gpapadopoulos'; GivenName = $P['gpapadopoulos'].GivenName; Surname = $P['gpapadopoulos'].Surname; DisplayName = $P['gpapadopoulos'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Financial Analyst'; OrgUnit = 'Finance'; Manager = 'awhitfield'; Groups = 'all-staff'; EmployeeNumber = 'E1024'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'el-GR'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'In no department group, because praghunathan is meant to be the only member the payroll rule admits. Greek final sigma, a different letter from the medial one, so upper-casing a name and lower-casing it again does not return the name' }
    [ordered]@{ Username = 'malahmad'; GivenName = $P['malahmad'].GivenName; Surname = $P['malahmad'].Surname; DisplayName = $P['malahmad'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Network Engineer'; OrgUnit = 'Engineering'; Manager = 'awhitfield'; Groups = 'all-staff;dept-engineering'; EmployeeNumber = 'E1025'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'ar-AE'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'Right-to-left text, which renders in an order that is not the order it is stored in wherever it is joined to a Latin login or a distinguished name' }
    [ordered]@{ Username = 'jmarchetti'; GivenName = $P['jmarchetti'].GivenName; Surname = $P['jmarchetti'].Surname; DisplayName = $P['jmarchetti'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Campaign Manager'; OrgUnit = 'Marketing'; Manager = 'mbell'; Groups = 'all-staff'; EmployeeNumber = 'E1026'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'it-IT'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'The same Jose the eye reads on jnino and a different string to every comparison, because this one is stored decomposed' }
    [ordered]@{ Username = 'iisik'; GivenName = $P['iisik'].GivenName; Surname = $P['iisik'].Surname; DisplayName = $P['iisik'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'HR Advisor'; OrgUnit = 'Human Resources'; Manager = 'awhitfield'; Groups = 'all-staff'; EmployeeNumber = 'E1027'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'tr-TR'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'Turkish dotted and dotless i, where lower-casing under a Turkish culture returns a different string from the invariant one, and a login derived that way stops matching' }
    [ordered]@{ Username = 'jweiss'; GivenName = $P['jweiss'].GivenName; Surname = $P['jweiss'].Surname; DisplayName = $P['jweiss'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Account Executive'; OrgUnit = 'Sales'; Manager = 'mbell'; Groups = 'all-staff;dept-sales'; EmployeeNumber = 'E1028'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'de-DE'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'An eszett, which upper-cases into two characters, so the name grows by one every time it is normalised for a comparison' }
    [ordered]@{ Username = 'schaudhary'; GivenName = $P['schaudhary'].GivenName; Surname = $P['schaudhary'].Surname; DisplayName = $P['schaudhary'].DisplayName; Lifecycle = 'Active'; Class = 'employee'; Title = 'Data Engineer'; OrgUnit = 'Engineering'; Manager = 'jnino'; Groups = 'all-staff;dept-engineering;team-platform'; EmployeeNumber = 'E1029'; EmployeeType = 'Employee'; LoginShell = '/bin/bash'; HomeDirectory = ''; Phone = ''; Mobile = ''; Street = ''; City = 'Seattle'; State = 'WA'; PostalCode = '98101'; PreferredLanguage = 'hi-IN'; UserAuthType = ''; PasswordState = 'MustChange'; PrincipalExpiresInDays = ''; SshPublicKeys = ''; CertMapData = ''; RadiusProxy = ''; RadiusUsername = ''; IdentityProvider = ''; IdpUserId = ''; NoPrivateGroup = 'FALSE'; PrimaryGroup = ''; Tier = 'Core'; Purpose = 'Devanagari with combining vowel signs, so the count of characters and the count of marks a reader sees are different numbers' }
)
...
foreach ($row in $bulkGroups) {
    ...
    $take = 3 + ($hash % 6)
    # The members are the people whose hash with the group sorts lowest. Indexing into the pool
    # by position, which this used to do, meant that adding one person anywhere in the AD data
    # moved every sampled membership in every provider; this way a new person joins a group only
    # where their own hash lands among its first few, and everyone else stays put.
    $groupKey = $row.Name
    foreach ($member in @($pool | Sort-Object -Property @{ Expression = { Get-StableHash "$groupKey|$_" } }, @{ Expression = { $_ } } | Select-Object -First $take)) {
        & $addMembership $member $row.Name
    }
}
