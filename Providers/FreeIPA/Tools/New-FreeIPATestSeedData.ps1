...
$coreGroups = @(
    [ordered]@{ Name = 'all-staff'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Organisation'; Description = 'Every internal employee'; Tier = 'Core'; Purpose = 'The root of the nesting chain and the broadest HBAC target' }
    [ordered]@{ Name = 'dept-engineering'; Type = 'posix'; GidNumber = ''; Parent = 'all-staff'; Category = 'Department'; Description = 'Engineering department'; Tier = 'Core'; Purpose = 'Second level of the chain; a department with a team beneath it, and the target of an automember rule' }
    [ordered]@{ Name = 'team-platform'; Type = 'nonposix'; GidNumber = ''; Parent = 'dept-engineering'; Category = 'Team'; Description = 'Platform engineering team'; Tier = 'Core'; Purpose = 'Third level; a non-POSIX group nested in a POSIX one, so membership resolves transitively but no GID does' }
    [ordered]@{ Name = 'dept-sales'; Type = 'posix'; GidNumber = ''; Parent = 'all-staff'; Category = 'Department'; Description = 'Sales department'; Tier = 'Core'; Purpose = 'A sibling department with no children, whose password policy never expires a password' }
    [ordered]@{ Name = 'dept-finance'; Type = 'posix'; GidNumber = ''; Parent = 'all-staff'; Category = 'Department'; Description = 'Finance department'; Tier = 'Core'; Purpose = 'The only group the payroll HBAC rule admits' }
    [ordered]@{ Name = 'contractors'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Population'; Description = 'External contractors'; Tier = 'Core'; Purpose = 'Deliberately outside the staff chain; filled by an automember rule, and the primary group of the user with no private group' }
    [ordered]@{ Name = 'site-zurich'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Site'; Description = 'Zürich office access'; Tier = 'Core'; Purpose = 'Non-ASCII description that must survive the round trip; the name itself cannot carry it' }
    [ordered]@{ Name = 'empty-hold'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Utility'; Description = 'A group with no members'; Tier = 'Core'; Purpose = 'A report has to handle zero members without special-casing; its automember rule can never match' }
    [ordered]@{ Name = 'lab-admins'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Role'; Description = 'Lab administrators'; Tier = 'Core'; Purpose = 'Named like an admin group and holding a seeded role, but never a member of admins' }
    [ordered]@{ Name = 'svc-accounts'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Utility'; Description = 'Service accounts'; Tier = 'Core'; Purpose = 'Every service account, and nothing human' }
    [ordered]@{ Name = 'ext-partners'; Type = 'external'; GidNumber = ''; Parent = 'ext-partners-posix'; Category = 'Trust'; Description = 'Partner accounts from a trusted domain'; Tier = 'Core'; Purpose = 'An external group: it can hold only trusted-domain SIDs, so it has no IPA members and no GID' }
    [ordered]@{ Name = 'ext-partners-posix'; Type = 'posix'; GidNumber = ''; Parent = ''; Category = 'Trust'; Description = 'POSIX wrapper for the partner group'; Tier = 'Core'; Purpose = 'The POSIX group the external one nests in, which is how a trust grants a GID; it has a member group and no users' }
)
...
$addHostgroup = {
    ...
    $bulkHostgroups.Add([ordered]@{ Name = $key; Parent = $parent; Description = $description; Tier = 'Bulk'; Purpose = $purpose })
}
